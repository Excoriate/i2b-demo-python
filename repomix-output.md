...
## File: src/app/api/v1/endpoints.py
```python
...
class Settings(BaseSettings):
    ...
    COUCHDB_DB_NAME: str = "apisq_db"

    # Application Settings
    APP_HOST: str = "0.0.0.0"
    APP_PORT: int = 8000
    LOG_LEVEL: str = "INFO"
    PROJECT_NAME: str = "i2b-demo-python API"
...
# You can access settings like: settings.COUCHDB_URL
```
...
# If running directly using uvicorn main:app --reload
# Note: Typically run via uvicorn command pointing to this file/app object
if __name__ == "__main__":
    import uvicorn
    # This is mainly for debugging. Production should use a process manager.
    # Use settings for host/port if available
...
## File: .env.example
```
# Environment variables for i2b-demo-python

# CouchDB Connection Details
COUCHDB_URL=http://localhost:5984/
COUCHDB_USER=admin
COUCHDB_PASSWORD=password
COUCHDB_DB_NAME=apisq_db
...
# PEP 582; used by PDM, Pyflow and potentially other tools.
__pypackages__/
...
dev = [
    ...
    "httpx>=0.24.0",                # Async HTTP client, needed for FastAPI TestClient
]
```
...
sdist = { url = "https://files.pythonhosted.org/packages/c1/b4/4f699a686a2ce14ab31cb17902693f2cf201ba51c3a6fb7aba210725c154/pycouchdb-1.16.0.tar.gz", hash = "sha256:309d71c3ce3f98bbee5731db00f514753438b81e6e7adefbb8c134312200a4f9", size = 11351 }
wheels = [
    { url = "https://files.pythonhosted.org/packages/4c/63/b4397a7215c089c7951afb258069cc58a06788224f1bb6a0d4f976f2d476/pycouchdb-1.16.0-py3-none-any.whl", hash = "sha256:e26ce58f626fcabbe2f5b15b3ad2b89cdd3f6d666da673632037476d1191ab67", size = 12560 },
]
